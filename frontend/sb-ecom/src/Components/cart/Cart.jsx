        ...
        <div className="lg:px-14 sm:px-8 px-4 py-10">
            ...
            <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
                ...
                <div className="flex text-sm gap-1 flex-col">
                    <div className="flex gap-2  w-full md:text-lg text-sm font-semibold">
                        <span>Checkout</span>
                    ...
                    <Link className="w-full flex justify-end" to="/checkout">
                        <button onClick={() => { }} className="font-semibold w-[300px] py-2 px-4 rounded-sm bg-custom-blue text-white flex items-center justify-center gap-2 hover:text-gray-300 transition duration-300">
                            <MdShoppingCart size={20} />
                            CheckOut
                        </button>
                    </Link>

                    <Link className="flex gap-2 items-center mt-2 text-slate-500" to="/product">
                        <MdArrowBack />
